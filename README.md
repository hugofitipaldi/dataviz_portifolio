...
\>4.5 million participants in the three countries used the app,
\~220,000 of whom live in Sweden. On July 11, 2022, with over 500
million data entries, in which Swedish participants contributed \~20
million of these, the project officially ended the data collection
phase.

-   **Maps and infographics**

During the early stages of the project, I have mainly produced maps,
plots and infographics for the CSSS. Most of these can be found in our
<a href = https://www.covid19app.lu.se/artikel/forsta-kartorna-fran-svenska-covid-symptom-study>
data archive</a>. The visualizations were released weekly and had the
aim to inform our participants, Swedish policymakers, and the general
public about our findings. Therefore, in order to facilitate
comprehension of our research results to our large audience, I had the
chance to experiment with different visualization styles, such as in
...
On July 22, 2020, we have launched the CSSS dashboard, an interactive
online solution for presenting our predictions and maps entirely
developed in R shiny and deployed at shinyapps.io.
...
I have built this dashboard as a results page for one of my PhD
publications. More details about this project can be found in [Fitipaldi
& Franks (Hum Mol Gen,
...
I was invited to create this infopgraphic and other figures that are
featured in the published consensus report: Precision medicine in
diabetes: a Consensus Report from the American Diabetes Association
(ADA) and the European Association for the Study of Diabetes (EASD),
<a href = https://link.springer.com/article/10.1007/s00125-020-05181-w>
Chung, W.K., Erion, K., Florez, J.C. et al. (Diabetologia, 2020)</a>
