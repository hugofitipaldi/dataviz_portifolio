...
On July 22, 2020, we have lauched the CSSS dashboard, an interactive online solution for presenting our predictions and maps entirely developed in R shiny and deployed at shinyapps.io.

The source code for the dashboard is oppenly available [here](https://github.com/hugofitipaldi/CSSS_dashboard)
